(function() {
  ...
  describe('GroupService', function () {
    ...
    beforeEach(inject(function (_$httpBackend_, _GroupService_) {
      ...
      // User the Jasmine spyOn method to setup a callback using our handler mock object
    ...
    it('should delete a group', function() {
      var id = '5666259dc6e3a5280b1209a6';
      var existingGroup = {
        _id : id,
        name : 'testGroup',
      ...
      $httpBackend.whenPOST(/delete\/(\S+)$/)
        ...
        // Setup the service to use the success and error handler function we defined in the beforeEach block.
